...
/**
 * _myenv - the current environ is printed
...
/**
 * _getenv - value of an environ variable is recieved
...
/**
 * _mysetenv -  this starts a new environment variable,
...
/**
 * _myunsetenv -   an environment variable is removed
